...
public class PlayerController : Singleton <PlayerController>
{
    ...
    void Update()
    {
        ...
        // when mario dies, fly to heaven
        // if (gameConstants.playerAlive == false) {
        //     GetComponent<Collider2D>().enabled  =  false;
        //     velocity = new Vector2(0, 11);
        //     marioBody.MovePosition(marioBody.position + velocity * Time.fixedDeltaTime);
        // }
    }
    ...
    void  PlayerDiesSequence(){
        ...
        // ...
        // gameConstants.playerAlive = false;
    }
}
